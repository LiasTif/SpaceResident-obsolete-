...
{
    internal interface ISkillPsychology
    {
        byte EmotionalIntelligence { get; private protected set; }
        ...
        void CalcSkillPsychology(byte existentialism, byte space, byte linguistics)
        {
            byte result = (byte)(existentialism * 0.4 + space * 0.4 + linguistics * 0.2);

            EmotionalIntelligence = (byte)(result * 3);
        }
    }
}